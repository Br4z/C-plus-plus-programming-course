...
int main() {
	...
	if (sum - max == max)
		cout << "There is an element in the vector that is equal to the sum of the rest of the elements" << endl;
	else
		cout << "There is NOT an element in the vector that is equal to the sum of the rest of the elements" << endl;
